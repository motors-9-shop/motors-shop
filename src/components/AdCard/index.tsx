    ...
    >
      ...
      <CardBody gap="16px" display="flex" flexDir="column">
        ...
        <Box display="flex" justifyContent="space-between">
          ...
          <Text textStyle="heading-7-500" color="grey.1">
            {ad.price}
          </Text>
        </Box>
      </CardBody>
